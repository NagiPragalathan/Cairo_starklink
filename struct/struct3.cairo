...
trait PackageTrait {
    ...
    fn get_fees(self: @Package, cents_per_gram: usize) -> usize;
}
...
impl PackageImpl of PackageTrait {
    ...
    fn is_international(self: @Package) -> bool {
        // If the sender and recipient countries are different, it's international.
        self.sender_country != self.recipient_country
    }

    fn get_fees(self: @Package, cents_per_gram: usize) -> usize {
        // Dereference self.weight_in_grams and calculate the fees.
...
fn create_international_package() {
    ...
    let package = PackageTrait::new(sender_country, recipient_country, 1200);
...
fn calculate_transport_fees() {
    ...
    let package = PackageTrait::new(sender_country, recipient_country, 1500);
